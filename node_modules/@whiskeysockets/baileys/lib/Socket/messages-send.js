...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        var _a;
        ...
        await authState.keys.transaction(async () => {
            ...
            if ((_g = message === null || message === void 0 ? void 0 : message.interactiveMessage) === null || _g === void 0 ? void 0 : _g.nativeFlowMessage) {
